...
export const ModalNewCar = ({ open_modal, close_modal }: IModalNewOffer) => {

    const [selectedFiles, setSelectedFiles] = useState<File[]>([]);

    const [loading, setLoading] = useState(false)

    const [form_offer, SetFormOffer] = useState<INewOffer>({
        model: '',
        brand: '',
        mileage: null,
        price: null,
    ...
    const createNewOffer = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            toast.error("Erro ao criar oferta, verifique os campos e tente novamente!")
                    ...
                    <Grid columns={12} container spacing={2}>
                        ...
                        <Grid item xs={12}>
                            <TextField
                                ...
                                required id="Data" type="date" size="small" variant="outlined" />
                        </Grid>
                        <Grid item xs={12}>
                            <label htmlFor="Files">Selecione as fotos *</label>
                            <input required id="Files" type="file" multiple onChange={handleFileChange} />
                        </Grid>
                        <Grid item xs={12}>
